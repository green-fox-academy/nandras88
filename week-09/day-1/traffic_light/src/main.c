...
int main(void) {
	...
	GPIO_InitTypeDef yellow;
	yellow.Pin = GPIO_PIN_10;
	yellow.Mode = GPIO_MODE_OUTPUT_PP;
	yellow.Pull = GPIO_PULLDOWN;
	yellow.Speed = GPIO_SPEED_HIGH;

	HAL_GPIO_Init(GPIOF, &yellow);
